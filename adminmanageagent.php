                                    ...
                                    <div class="card-body">
                                        <h4 class="card-title">Manage Agent</h4>
                                            ...
                                            <div class="form-group row">
                                                    <div class="col-md-9">
                                                        <input id="searchagent" class="form-control" type="text" name="SearchAgent"  placeholder="Search Agent...">          
                                                    </div>
                                                    <div class="col-md-2">
                                                            ...
                                                            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" onSubmit="return addmodalvalidate();" >
                                                                ...
                                                                <div class="modal-body">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" id="agent_name" name="agent_name" class="form-control" placeholder="Enter Agent Name" required>
                                                                            ...
                                                                            <input type="text" id="company_name" name="company_name"  class="form-control" placeholder="Enter Company Name" required> </div>
                                            ...
                                            <table id="demo-foo-addrow" class="table m-t-30 table-hover no-wrap contact-list" data-page-size="10" style="width: 100%;">
                                                ...
                                                <?php
                                                    ...
                                                    $result = $conn->query($sql);
                                                        ...
                                                        ?>
                                                    <tr>
                                                        <td class="a_id" ><?php echo $data['a_id']; ?></td>
                                                        <td>
...
<script type="text/javascript">
 ...
 $(document).ready(function(){
    $('.editbutton').click(function () {
        ...
        var id=$(this).closest('tr').children('td.a_id').text();
      ...
      var company=$(this).closest('tr').children('td.company_name').text();
...
var letter = document.getElementById('agent_name').value;
...
var letter1 = document.getElementById('company_name').value;
...
var letter1 = document.getElementById('agentname').value;
var regexletter1 = /^[a-zA-Z\s]+$/;
if(!regexletter1.test(letter1)){
alert("please enter only letters in Agent Name.");
...
var letter2 = document.getElementById('companyname').value;
var regexletter2 = /^[a-zA-Z\s]+$/;
if(!regexletter2.test(letter2)){
alert("please enter only letters in Company Name.");
...
$sql="INSERT INTO `agent`(`name`, `email_id`, `password`, `mobile_no`, `company_name`) VALUES ('".$agentname."','".$email."','".$password."','".$mobile."','".$company."')";
$result=mysqli_query($conn,$sql);


echo '<script>
			window.location.href="adminmanageagent.php";
	</script> ';
}
...
$sql= "UPDATE `agent` SET name='$name', email_id ='$email_id',password='$password',mobile_no='$mobile_no',company_name='$company_name' WHERE `a_id` = $id";
 mysqli_query($conn,$sql);

        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Manage Faculty</h3>
                    </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Manage Faculty</h4>
                                            ...
                                            <div class="col-md-9">
                                                        <input id="searchagent" class="form-control" type="text" name="SearchAgent"  placeholder="Search Faculty...">          
                                                    </div>
                                                    <div class="col-md-2">
                                            ...
                                            <table id="demo-foo-addrow" class="table m-t-30 table-hover no-wrap contact-list" data-page-size="10" style="width: 100%;">
                                                ...
                                                ?>
                                                    <tr>
                                                        <td class="f_id"><?php echo $data['f_id']; ?></td>
                                                        <td>
      ...
      <div class="modal-content">
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" onSubmit="return editmodalvalidate();">
          ...
          <div class="form-group">
               ...
               <label>Faculty name</label>
               <input type="text"  name="name" id="fname" class="form-control name_modal" required>
               <label>Email ID</label>
               <input type="email"  name="email_id" id="emailid" class="form-control email_id_modal"required>
               <label>Insitute Email ID</label>
               <input type="email"  name="i_email_id" id="i_emailid" class="form-control i_email_id_modal"required>
               <label>Mobile No.</label>
               <input type="number" name="mobile_no" id="mobile" class="form-control mobile_modal"  required>
               <label>Gender</label>
               ...
               <label>College</label>
               <input type="text"  name="college" id="cname" class="form-control college_modal" required>
               
            </div>
          </div>
          <input type="hidden" name="f_id" class="user_id">
          <div class="modal-footer">
...
<script src="assets/plugins/bootstrap-select/bootstrap-select.min.js" type="text/javascript"></script>
 ...
 $(document).ready(function(){
    $('.editbutton').click(function () {
        ...
        var id=$(this).closest('tr').children('td.f_id').text();
      ...
      $('.i_email_id_modal').val(iemail_id);
...
alert("please enter only letters in Faculty Name.");
...
var let1 = document.getElementById('fname').value;
var regexlet1 = /^[a-zA-Z\s]+$/;
if(!regexlet1.test(let1)){
alert("please enter only letters in Faculty Name.");
...
var let2 = document.getElementById('cname').value;
var regexlet2 = /^[a-zA-Z]+$/;
if(!regexlet2.test(let2)){
alert("please enter only letters in College.");
...
$sql="INSERT INTO `faculty`(`name`, `email_id`,`institute_email_id`, `password`, `gender` , `mobile_no`, `college`) VALUES ('".$name."','".$email."','".$iemail."','".$password."','".$gender."','".$mobile."','".$college."')";
$result=mysqli_query($conn,$sql);


echo '<script>
			window.location.href="adminmanagefaculty.php";
	</script> ';
}
...
$sql= "UPDATE `faculty` SET name='$name', email_id ='$email_id', institute_email_id ='$iemail_id',password='$password', gender ='$gender',mobile_no='$mobile_no',college='$college' WHERE `f_id` = $id";
 mysqli_query($conn,$sql);

...
<html lang="en">
               ...
               <head>
                   ...
                   <title>Admin | Manage Parent</title>
                   <!-- Bootstrap Core CSS -->
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Manage Parent</h3>
                    </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Manage Parent</h4>
                                            ...
                                            <div class="col-md-9">
                                                        <input id="searchagent" class="form-control" type="text" name="SearchAgent" placeholder="Search Parent...">          
                                                    </div>
                                                    <div class="col-md-2">
                                                            ...
                                                            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post"  onSubmit="return addmodalvalidate();" >
                                                                ...
                                                                <div class="modal-body">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" id="parent_name" name="parent_name" class="form-control" placeholder="Enter Parent Name" required>
                                                                            ...
                                                                            while($data1=mysqli_fetch_array($result1))
                                                                              {
                                                                            echo "<option value=".$data1['f_id'].">" .$data1['name']. "-" .$data1['college'].  "</option>";
                                                                            }
                                                                            ?>
                                                                            </select>  
                                                                        </div>
                                            ...
                                            <table id="demo-foo-addrow" class="table m-t-30 table-hover no-wrap contact-list" data-page-size="10" style="width: 100%;"> 
                                                ...
                                                $result = $conn->query($sql);
                                                    ...
                                                    ?>
                                                    <tr>
                                                         <td class="p_id" ><?php echo $data['p_id']; ?></td>
                                                        <td>
      ...
      <div class="modal-content">
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" onSubmit="return editmodalvalidate();">
          ...
          <div class="form-group">
               ...
               <label>Parent name</label>
               <input type="text"  name="name" id="parentname" class="form-control name_modal" required>
               <label>Email ID</label>
         ...
         <label>Select Faculty</label>
          ...
          <input type="hidden" name="p_id" class="user_id">
          <div class="modal-footer">
...
<script src="assets/plugins/bootstrap-select/bootstrap-select.min.js" type="text/javascript"></script>
 ...
 $(document).ready(function(){
    $('.editbutton').click(function () {
        ...
        var id=$(this).closest('tr').children('td.p_id').text();
      ...
      var student=$(this).closest('tr').children('td.student_id').text();
      $('.student_modal').val(student);
...
var letter = document.getElementById('parent_name').value;
var regexletter = /^[a-zA-Z\s]+$/;
if(!regexletter.test(letter)){
alert("please enter only letters in Agent Name.");
...
var letter1 = document.getElementById('parentname').value;
...
$sql = "SELECT * FROM `student` where student_id = ".$student." AND f_id=".$faculty."";
$r = $conn->query($sql);
$d=mysqli_fetch_array($r);
...
$sql="INSERT INTO `parent`(`name`, `email_id`, `password`, `mobile_no`, `student_id`,`f_id`,`visit_id`) VALUES ('".$name."','".$email."','".$password."','".$mobile."','".$student."','".$faculty."','".$vid."')";
$result=mysqli_query($conn,$sql);


echo '<script>
			window.location.href="adminmanageparent.php";
	</script> ';
}
...
$sql = "DELETE FROM `parent` WHERE `p_id` = ".$id."";
...
$sql= "UPDATE `parent` SET name='$name', email_id ='$email_id',password='$password',mobile_no='$mobile_no',student_id='$student',f_id='$faculty',visit_id='$vid' WHERE `p_id` = $id";
 mysqli_query($conn,$sql);

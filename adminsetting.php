                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post"  onSubmit="return passvalidate();" >
                                ...
                                <input type="hidden" name="admin_id" id="admin_id" value="<?php echo $userdata['ad_id']?>">
...
return false;
    ...
    <?php
        ...
        $sql= "UPDATE `admin` SET password='$password' WHERE `ad_id` = $id";
...
if (isset($_POST['submit_btn']))
    ...
    $sql= "UPDATE `admin` SET name='$name', email_id ='$email' WHERE `ad_id` = $id";
    mysqli_query($conn,$sql);

        ...
        <header class="topbar">
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="agent.php">
                        <!-- Logo icon --><b>
                                ...
                                <ul class="dropdown-user">
                                    <li>
                                        <div class="dw-user-box">
                                            ...
                                            <p class="text-muted"><?php echo $userdata['email_id']; ?></p><a href="agentprofile.php" class="btn btn-rounded btn-danger btn-sm">My Profile</a></div>
                                        </div>
                                    </li>
                                   
                                    <li role="separator" class="divider"></li>
                                    <li><a href="agentsetting.php"><i class="ti-settings"></i> Account Setting</a></li>
                                    <li role="separator" class="divider"></li>
            ...
            <div class="scroll-sidebar">
                ...
                <div class="user-profile">
                    ...
                    <h5><?php echo $userdata['name']; ?></h5>
                        ...
                        <div class="dropdown-menu animated flipInY">
                         <!-- text--> 
                         <a href="agentprofile.php" class="dropdown-item"><i class="ti-user"></i> My Profile</a>
                         <!-- text-->  
                 
                         <!-- text--> 
                         <div class="dropdown-divider"></div>
                         <!-- text-->  
                         <a href="agentsetting.php" class="dropdown-item"><i class="ti-settings"></i> Account Setting</a>
                         <!-- text--> 
                         <div class="dropdown-divider"></div>
                         <!-- text-->  
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a  href="agent.php" ><i class="mdi mdi-gauge"></i><span class="hide-menu">Dashboard</span></a>
                        </li>
                      
                        <li> <a class="has-arrow waves-effect waves-dark" aria-expanded="false" href="#"><i class="mdi mdi-voice"></i><span class="hide-menu">Insurance</span></a>
                            <ul aria-expanded="false" class="collapse">
                                    <li><a href="agentinsurance.php#add">Add Insurance Company</a></li>
                                    <li><a href="agentinsurance.php#view">View Companies</a></li>
                                    
                                </ul>
                        </li>
                        
                        <li> <a href="agentupdatestatus.php" ><i class="mdi mdi-format-quote"></i><span class="hide-menu" >Update Status</span></a>
                          </li>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
                                    <h4 class="card-title">
                                            <span id="add"> &nbsp; </span>
                                            Add Insurance Company</h4>
                                            <input type="hidden" type="text" name="aid" id="aid" value="<?php echo $userdata['a_id'];?>">
                                    <div class="form-group row">
                                                    <label for="example-text-input" class="col-md-4 col-form-label">Enter Company Name</label>
                                                    <div class="col-md-8">
                                                            <input class="form-control" type="text" value="" id="company" name="company" placeholder="Company Name..." >
                                                    </div>
                                    </div>
                                    <div class="form-group row">
                                                    <label for="example-text-input" class="col-md-4 col-form-label">Insurance Type/Name</label>
                                                    <div class="col-md-8">
                                                            <input class="form-control" type="text" value="" id="name" name="name" placeholder="Insurance Name..." >
                                                    </div>
                                    </div>
                                    <div class="form-group row">
                                            <label for="example-text-input" class="col-md-4 col-form-label">Insurance Amount</label>
                                            <div class="col-md-8">
                                                    <input class="form-control" type="number" value="" id="amount" name="amount" placeholder="Amount..." >
                                            </div>
                                   </div>
                                        ...
                                        <h4 class="card-title">Upload Related Documents</h4>
                                            ...
                                            <div class="fallback ">
                                                <input  type="file" name="pdf" id="pdf" accept="application/pdf">
                                                                        ...
                                                                        <br>
                                         <input type="submit" id="submit_btn" class="btn btn-success"  name="submit_btn" value="Add Company">
                                </div>
                                </form>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        $sql = "SELECT * FROM `insurance` where a_id=".$userdata['a_id']."";
...
if(move_uploaded_file($_FILES['pdf']['tmp_name'], $target)) {
     ...
     $sql="INSERT INTO `insurance`(`company_name`, `insurance_name`, `amount`, `description`,`docs`,`a_id`) VALUES ('".$company."','".$name."','".$amount."','".$desc."','".$target."','".$aid."')";
     $result=mysqli_query($conn,$sql);
     
     echo '<script>
    window.location.href="agentinsurance.php";
    </script> ';
    }else {

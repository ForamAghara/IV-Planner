...
<head>
    ...
    <title>Agent | Account Settings</title>
    <!-- Bootstrap Core CSS -->
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post"  onSubmit="return passvalidate();">
                                ...
                                <input type="hidden" name="agent_id" id="agent_id" value="<?php echo $userdata['a_id']?>">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                                ...
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-md-4 col-form-label">Change Company Name</label>
                                    <div class="col-md-8">
                                            <input class="form-control" type="text" value="<?php echo $userdata['company_name']; ?>" id="company" name="company" placeholder="" required>
                                    </div>
                    </div>
...
return false;
    ...
    <?php
        ...
        $sql= "UPDATE `agent` SET password='$password' WHERE `a_id` = $id";
...
if (isset($_POST['submit_btn']))
    ...
    $sql= "UPDATE `agent` SET name='$name', email_id ='$email',mobile_no = '$mobile',company_name='$company' WHERE `a_id` = $id";
    mysqli_query($conn,$sql);
  
    
    
     echo '<script>
                window.location.href="agentsetting.php";
        </script> ';

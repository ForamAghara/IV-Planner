                                ...
                                <div class="card">
                                    <div class="card-body">
                                      <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                                        <h4 class="card-title">Set Company Availability Dates</h4>
                                                
                                                <h6 class="card-title m-t-10">Current Company Availability -> &nbsp;&nbsp;&nbsp;From : <?php echo $userdata['start_date'];?>&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;To : <?php echo $userdata['end_date'];?></h6>
                                            <!-- Column --><br>
                                            <div class="form-group row">
                                                    ...
                                                    <div class="col-md-3">    
                                                        <input class="form-control" type="date" name="start" id="enddate" placeholder="DATE...">            
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <input class="form-control" type="date" name="end" id="enddate" placeholder="DATE...">            
                                                    </div>
                                                    <input type="hidden" name="cid" value="<?php echo $userdata['c_id'];?>">
                                                    <div class="col-md-3">
                                                    <input type="submit" class="btn btn-warning" name="Save_btn" value="Save">
                                                      </div>  
...
$sql="UPDATE `company_person` SET start_date='$start', end_date='$end' WHERE `c_id` = $cid";

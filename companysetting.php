...
<head>
    ...
    <title>Company | Account Settings</title>
    <!-- Bootstrap Core CSS -->
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post"  onSubmit="return passvalidate();">
                                ...
                                <input type="hidden" name="company_id" id="company_id" value="<?php echo $userdata['c_id']?>">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                                ...
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-md-4 col-form-label">Change Company </label>
                                    <div class="col-md-8">
                    ...
                    <div class="form-group row">
                                    <label for="example-text-input" class="col-md-4 col-form-label">Change City</label>
                                    <div class="col-md-8">
                                    <input class="form-control" type="text" value="<?php echo $userdata['company_city']; ?>" id="city" name="city" placeholder="" required>
                                    </div>
                    </div>
...
return false;
    ...
    <?php
        ...
        $sql= "UPDATE `company_person` SET password='$password' WHERE `c_id` = $id";
...
if (isset($_POST['submit_btn']))

    {
        ...
        $sql= "UPDATE `company_person` SET name='$name', email_id ='$email',mobile_no = '$mobile',company_name='$company',company_city='$city' WHERE `c_id` = $id";
    mysqli_query($conn,$sql);
  
    
    
     echo '<script>
                window.location.href="companysetting.php";
        </script> ';

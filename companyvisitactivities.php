...
if(isset($_SESSION['username']) && isset($_SESSION['user']) ){
    if($_SESSION['user']=="company"){
        ...
        if(isset($_POST['save']) && isset($_POST['visit_activities']) && $_POST['visit_activities'] != '') {
            $sel = "UPDATE company_person SET visit_activities = '" . $_POST['visit_activities'] . "' WHERE c_id = " . $userdata['c_id'];
            mysqli_query($conn,$sel);
            $userdata['visit_activities'] = $_POST['visit_activities'];
        }    
}
else{
...
<head>
    ...
    <title>Company | Visit Activities</title>
    <!-- Bootstrap Core CSS -->
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Visit Activities</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Dashboard</a></li>
                        
                        <li class="breadcrumb-item active">Visit Activities</li>
                    </ol>
                </div>
            </div>
            <!-- ============================================================== -->
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                            <div class="card">
                                  <div class="card-body">
                                        <h3 class="card-title">Visit Activities</h3>
                                        <form action="<?=$_SERVER['PHP_SELF']?>" method="POST">
                                            <div class="form-group">
                                                <textarea class="textarea_editor form-control" rows="15" placeholder="Enter feedback and share link of report ..." name="visit_activities"><?=$userdata['visit_activities']?></textarea>
                                            </div>

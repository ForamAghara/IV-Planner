                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="selectpicker m-b-20 m-r-10" data-style="btn-info btn-outline-info" id="student_id" name="student_id" required> 
                                                             ...
                                                             <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" placeholder="Enter Enrollment No.">
                                                                <label>Student Name</label>
                                                                <input type="text" class="form-control" placeholder="Enter Student Name">
                                                                <label>Enter Visit ID</label>
                                                            <input type="text" class="form-control" placeholder="Enter Visit ID">
                                                                <label>Year</label>
...
echo '<script>
      window.location.href="facultyblacklist.php";
  </script> ';
}

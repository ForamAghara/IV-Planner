...
<html lang="en">
               ...
               <head>
                   ...
                   <title>Faculty | Create Invoice</title>
                   <!-- Bootstrap Core CSS -->
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Create Invoice</h3>
                    </div>
                ...
                <div class="row">
                    ...
                    <h4 class="card-title">Create Invoice</h4>
                            ...
                            <div class="form-group row">
                                    <label for="example-text-input" class="col-md-4 col-form-label">Select Due Date</label>
                                    <div class="col-md-8">
                                            <input class="form-control" type="date" value="" id="date" placeholder="DATE...">
                                    </div>
                                </div>
                                <div class="form-group row">
								 <label for="example-text-input" class="col-md-4 col-form-label">Select student</label>
                                        <div class="col-md-6">
                               <select class="selectpicker m-b-20 m-r-10" data-style="btn-info btn-outline-info">
                                                            ...
                                                            <option data-tokens="">150570107000 Student 1</option>
                                                            <option data-tokens="">150570107001 Student 2</option>
                                                            <option data-tokens="">150570107002 Student 3</option>
                                                        </select>  
                            </div>
                            ...
                            <div class="table-responsive">
                                    <table id="demo-foo-addrow" class="table m-t-30 table-hover no-wrap contact-list" data-page-size="10">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>1.</td>
                                                <td>Trip Amount</td>
                                                <td> <input class="form-control" type="Text" value="" id="amount" placeholder="Details if any..." ></td>
                                                <td> <input class="form-control" type="number" value="" id="amount" placeholder="AMOUNT..." ></td>
                                            </tr>
											<tr>
                                                <td>2.</td>
                                                <td>Buffer Amount</td>
                                ...
                                <div class="form-group row">
                                        <div class="col-md-4">
                                <a href="" class="btn btn-success">Create Invoice</a> </div>
									<div class="col-md-1">
								 </div>
								<div class="col-md-4">
                                        <div class="btn-group ">
                                                ...
                                                <div class="dropdown-menu">
                                                  <a class="dropdown-item" href="#">Publish To All</a>
                                                  <a class="dropdown-item" href="#">Publish By Student</a>
                                                </div>
                                              </div>
                            </div>
                            </div>

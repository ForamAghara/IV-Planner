                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post"  onSubmit="return passvalidate();">
                                ...
                                <input type="hidden" name="faculty_id" id="faculty_id" value="<?php echo $userdata['f_id']?>">
...
alert("please enter valid Institue Email Id.");
...
return false;
    ...
    <?php
        ...
        $sql= "UPDATE `faculty` SET password='$password' WHERE `f_id` = $id";
...
if (isset($_POST['submit_btn']))
    ...
    $sql= "UPDATE `faculty` SET name='$name', email_id ='$email', institute_email_id='$iemail', mobile_no='$mobile', gender='$gender', college='$college' WHERE `f_id` = $id";
    mysqli_query($conn,$sql);
  
    
    
     echo '<script>
                window.location.href="facultysetting.php";
        </script> ';

...
<html lang="en">
               ...
               <head>
                   ...
                   <title>Faculty | Undertaking Management</title>
                   <!-- Bootstrap Core CSS -->
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Undertaking Management</h3>
                    </div>
                    <div class="col-md-7 align-self-center">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Dashboard</a></li>
                               <li class="breadcrumb-item active">Undertaking Management</li>
                        </ol>
                    </div>
                </div>    
                <!-- ============================================================== -->
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                        <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Undertaking List</h4>
                                        <div class="col-md-9">
                                            ...
                                            <div class="col-md-6 col-lg-3 col-xlg-3">
                                                <div class="card card-inverse card-info">
                                                    <div class="box bg-info text-center">
                                                        ...
                                                        <?php 
                                                             $sql="SELECT count(*) as name from visit where `f_id`=".$userdata['f_id']."";
                                                             $result = $conn->query($sql);
                                                            $data=mysqli_fetch_assoc($result);
                                                            echo $data['name'];
                                                        ?>
                                                        </h1>
                                                        <h6 class="text-white">Active Trips</h6>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- Column -->
                                            <div class="col-md-6 col-lg-3 col-xlg-3">
                                                <div class="card card-success card-inverse">
                                                    <div class="box text-center">
                                                        <h1 class="font-light text-white">
                                                          <?php
                                                      $sql="SELECT count(*) as name from student where f_id=".$userdata['f_id']." AND registered= 'YES' ";
                                                       $result = $conn->query($sql);
                                                      $data=mysqli_fetch_assoc($result);
                                                      echo $data['name'];
                                                      ?>
                                                       </h1>
                                                        <h6 class="text-white">Students Registered</h6>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- Column -->
                                                ...
                                                <div class="card card-inverse card-danger">
                                                    <div class="box text-center">
                                                      ...
                                                      ?>
                                                        ...
                                                        <h6 class="text-white">Undertakings Submitted</h6>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- Column -->
                                                ...
                                                <div class="card card-inverse card-dark">
                                                    <div class="box text-center">
                                                      ...
                                                      ?>
                                                        ...
                                                        <h6 class="text-white">Undertakings Pending</h6>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- Column -->
                                        ...
                                        <div class="table-responsive">
                                          <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post"> 
                                                  ...
                                                  if(mysqli_num_rows($result)>0)
                                                       ...
                                                       while($data=mysqli_fetch_array($result))
                                                        {
                                                          ...
                                                          $sel = "SELECT * from `student` where student_id= ".$data['student_id']."";
                                                          $rel = $conn->query($sel);
                                                   ...
                                                   ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width:20px;">
                                                         <!-- <span class="round"><img src="assets/images/users/8.jpg" alt="user" width="20">-->
                                                          <?php echo $studata['name'];?>
                                                          </span>
                                                        </td>
                                                        <td><?php echo $studata['email_id'];?></td>
                                                        <td><?php echo $data['coordinator_name'];?></td>
                                                        <td>
                                                          <span class="<?php if($data[status]=="submitted") 
                                                          {
                                            ...
                                            <div class="col-md-2">
                                                    <a href="" class="btn btn-warning">Notify To Pending Students</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>

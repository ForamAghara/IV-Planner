...
<head>
    ...
    <title>Parent | Coordinators</title>
    <!-- Bootstrap Core CSS -->
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Trip Coordinators</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Dashboard</a></li>
                        
                        <li class="breadcrumb-item active">Trip Coordinators</li>
                    </ol>
                </div>
            </div>
            <!-- ============================================================== -->
                                        ...
                                        <div class="right-page-header">
                                                <div class="d-flex">
                                                    <div class="align-self-center">
                                                        <h4 class="card-title m-t-10">Trip Coordinators List </h4></div>
                                                </div>
                                            </div>
                                            <div class="table-responsive">
                                                <table id="demo-foo-addrow" class="table m-t-30 table-hover no-wrap contact-list" data-page-size="10">
                                                    ...
                                                    <?php
                                                        ...
                                                        $sql = "SELECT * FROM `coordinator` where f_id=".$userdata['f_id']." AND visit_id=".$userdata['visit_id']." ";
                                                        ...
                                                        <tr>    
                                                            ...
                                                            <td><span class="<?php if($data['designation']=="student") { echo "label label-info"; } else {echo "label label-inverse";}?>"><?php echo $data['designation'];?></span></td>

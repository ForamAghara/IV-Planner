        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Student Invoice</h3>
                    </div>
                    <div class="col-md-7 align-self-center">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Dashboard</a></li>
                               <li class="breadcrumb-item active">Student Invoice</li>
                        </ol>
                    </div>
                </div>    
                <!-- ============================================================== -->
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-body printableArea">
                            <h3><b>INVOICE</b> <span class="pull-right">#150570107002</span></h3>
                            <hr>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="pull-left">
                                        <address>
                                            <h3> &nbsp;<b class="text-danger">Marwadi University</b></h3>
                                            <p class="text-muted m-l-5">FOE
                                                <br/> CE department
                                                <br/> C1 Class
                                       </address>
                                    </div>
                                    <div class="pull-right text-right">
                                        <address>
                                            <h3>To,</h3>
                                            <h4 class="font-bold">Foram Aghara</h4>
                                            <p class="text-muted m-l-30">201, Shagun,
                                                <br/> 5 Milapnagar,
                                                <br/> University Road,
                                                <br/> Rajkot - 360005</p>
                                            <p class="m-t-30"><b>Invoice Date :</b> <i class="fa fa-calendar"></i> 23rd Nov 2018</p>
                                            <p><b>Due Date :</b> <i class="fa fa-calendar"></i> 25th Nov 2018</p>
                                        </address>
                                    </div>
                                </div>
                                <div class="col-md-12">

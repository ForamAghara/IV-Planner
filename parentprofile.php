                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <?php 
                                    $sql = "SELECT * from `student` where `student_id` = ".$userdata['student_id']."";
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8 col-form-label">
                            <h5><?php echo $userdata['mobile_no']; ?></h5>
                                ...
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-md-4 col-form-label">Ward Enrollment No.</label>
                                    <div class="col-md-8 col-form-label">
                                        <h5><?php echo $stu['enroll_no']; ?></h5>
                                 </div>
                    </div>

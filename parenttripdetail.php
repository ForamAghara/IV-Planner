...
<head>
    ...
    <title>Parent | Trip Details</title>
    <!-- Bootstrap Core CSS -->
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Trip Details</h3>
                </div>
                    ...
                    <div class="col-12">
                            ...
                            <div class="card-body">
                                    ...
                                    ?>
                                        ...
                                        <div class="form-group row">
                                        <?php   $sel11 = "SELECT * from `student` where student_id= ".$userdata['student_id']."";
                                             $re11= $conn->query($sel11);
                                             $a11=mysqli_fetch_array($re11);?>
                                                <label for="example-text-input" class="col-md-4 col-form-label">Ward Registered</label>
                                                <div class="col-md-8">
                                                       <?php echo $a11['registered'];?>
                                                </div>
                                        </div>                   
                                    </div>
                            </div>

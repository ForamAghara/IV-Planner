...
<html lang="en">
               ...
               <head>
                   ...
                   <title>Parent | Undertaking</title>
                   <!-- Bootstrap Core CSS -->
                                ...
                                <div class="card">
                                      <div class="card-body">
                                          <?php 
												...
												$sel = "SELECT * from `student` where student_id=".$userdata['student_id']."";
												$rel = $conn->query($sel);
												$studata = mysqli_fetch_array($rel);
                                            ?>
                                          <div  id="undertaking">
                                                  <h2  style="text-align:center;"><b><u>UNDERTAKING BY STUDENTS</u></b></h2>
                                                  <p style="text-align:justify; font-size:17px">I,	Mr./Ms. <?php echo $studata['name'];?> En. No. <?php echo $studata['enroll_no']?> of <?php echo $studata['branch'];?> Semester: <?php echo $studata['semester'];?> do hereby undertake and abide by the following terms:</p>
                                                  ...
                                                  <p style="text-align:justify; font-size:17px" >I,	 Mr./Ms. ..................................................................................................... Father/	 Mother	 of	Mr./Ms. <?php echo $studata['name'];?> En. No. <?php echo $studata['enroll_no']?> doing	 his/her <?php echo $studata['branch']?>: Semester: <?php echo $studata['semester']?>	do	 hereby undertake	and abide by	the	aforesaid terms:</p>
                                                  <p style="text-align:justify; font-size:17px" >My	 Son/Daughter	 has	 informed	 me	 that	 he/she	 will	 carry	 out/	 attend	 Industrial	Visit/Educational Tour	 at	<?php echo $vdata['city'];?>	 outside	 the	<?php echo $studata['college'];?>	 campus starting from	 <?php echo $vdata['starting_date'];?>	to	<?php echo $vdata['ending_date'];?>. I	am	permitting	him/her for	the	same and	I	will	take	full	responsibility	during	this	period	of	stay	outside	the	<?php echo $studata['college'];?>	campus. I	am	aware that <?php echo $studata['college'];?>	is	not responsible	for	any	loss	to	an individual	or	group	occurred	due	to	any	action	by	any	individual or	group	during	tour	as	this	is extra-curricular	activity.</p>

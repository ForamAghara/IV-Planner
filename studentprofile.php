                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-md-4 col-form-label">Enrollment No.</label>
                                    <div class="col-md-8 col-form-label">
                                           <h5><?php echo $userdata['enroll_no']; ?></h5>
                                    </div>
                                </div>
								<div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-md-4 col-form-label">Branch</label>
                                    <div class="col-md-8 col-form-label">
                                           <h5><?php echo $userdata['branch']; ?></h5>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-md-4 col-form-label">Gender</label>
                                    <div class="col-md-8 col-form-label">
                                           <h5><?php echo $userdata['gender']; ?></h5>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-md-4 col-form-label">Father Mobile No.</label>
                                    <div class="col-md-8 col-form-label">
                                           <h5><?php echo $userdata['father_mobile_no']; ?></h5>
                                    </div>
                                </div>
								<div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-md-4 col-form-label">Institute Email Id</label>
                                    <div class="col-md-8 col-form-label">
                                        <h5><?php echo $userdata['institute_email_id']; ?></h5>
                                 </div>
                                 </div>
                                 <div class="form-group row">
                                    <label for="example-text-input" class="col-md-4 col-form-label">Hostel</label>
                                    <div class="col-md-8 col-form-label">
                                           <h5><?php echo $userdata['hostel']; ?></h5>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-md-4 col-form-label">Jain Food</label>
                                    <div class="col-md-8 col-form-label">
                                           <h5><?php echo $userdata['jain_food']; ?></h5>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-md-4 col-form-label">Room Preference ID</label>
                                    <div class="col-md-8 col-form-label">
                                           <h5><?php echo $userdata['room_preference']; ?></h5>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-md-4 col-form-label">Blacklisted</label>
                                    <div class="col-md-8 col-form-label">
                                           <h5><?php echo $userdata['blacklisted']; ?></h5>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-md-4 col-form-label">Payment 1</label>
                                    <div class="col-md-8 col-form-label">
                                           <h5><?php echo $userdata['payment_1']; ?></h5>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-md-4 col-form-label">Payment 2</label>
                                    <div class="col-md-8 col-form-label">
                                           <h5><?php echo $userdata['payment_2']; ?></h5>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-md-4 col-form-label">Semester</label>
                                    <div class="col-md-8 col-form-label">
                                           <h5><?php echo $userdata['semester']; ?></h5>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-md-4 col-form-label">Class</label>
                                    <div class="col-md-8 col-form-label">
                                           <h5><?php echo $userdata['class']; ?></h5>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-md-4 col-form-label">College</label>
                                    <div class="col-md-8 col-form-label">
                                        <h5><?php echo $userdata['college']; ?></h5>
                                 </div>
                    </div>
                                </div>

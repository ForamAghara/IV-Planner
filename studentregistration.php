...
<body class="fix-header fix-sidebar card-no-border" >
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Trip Registration</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Dashboard</a></li>
                        
                        <li class="breadcrumb-item active">Trip Registration</li>
                    </ol>
                </div>
            </div>
            <!-- ============================================================== -->
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                            <div class="card">
                                  <div class="card-body">
                                    <?php 
                                             $sel1 = "SELECT * from `visit` where visit_id= ".$userdata['visit_id']."";
                                             $re = $conn->query($sel1);
                                             $a=mysqli_fetch_array($re);
                                    ?>

                                        <h3 class="card-title">Trip Details and Registration</h3>
                                        <br>
                                        ...
                                        <tbody >
                                        <?php 
                                            $sel2 = "SELECT * from `micro_planning` where visit_id= ".$userdata['visit_id']." AND f_id=".$userdata['f_id']."";
                                            $r2 = $conn->query($sel2);
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                       Rs.  <?php echo $a['cost'];?> (*Including insurance amount)
                                                </div>
                                        </div>
                                        <h6>If you are interested register by clicking the button below!!</h6>
                                        <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" >
                                        <input type="hidden" type="text" name="stuid" id="stuid" value="<?php echo $userdata['student_id'];?>">
                                        <input type="hidden" type="text" name="fid" id="fid" value="<?php echo $userdata['f_id'];?>">
                                        <input type="hidden" type="text" name="vid" id="vid" value="<?php echo $userdata['visit_id'];?>">
                                        <input type="submit" id="submit_btn" class="btn btn-success"  name="submit_btn" value="<?php if($userdata['registered'] == "YES") { echo "Registered";} else { echo "Register";} ?>">    
                                        </form>                    
                                    </div>
                            </div>
                        </div>
  ...
  if(isset($_POST['submit_btn'])){ 
    ...
    $vid = $_POST['vid'];
    $r = "YES";
    $sql = "UPDATE `student` SET registered='$r' WHERE `student_id` = $id";
    mysqli_query($conn,$sql);


    $sql8="INSERT INTO `undertaking`(`student_id`, `f_id`, `visit_id`) VALUES ('".$id."','".$fid."','".$vid."')";
